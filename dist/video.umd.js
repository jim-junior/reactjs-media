(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/slicedToArray'), require('react'), require('react-icons/md'), require('prop-types')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/slicedToArray', 'react', 'react-icons/md', 'prop-types'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.reactjsvideo = {}, global._regeneratorRuntime, global._asyncToGenerator, global._slicedToArray, global.React, global.md, global.PropTypes));
}(this, (function (exports, _regeneratorRuntime, _asyncToGenerator, _slicedToArray, React, md, PropTypes) { 'use strict';
  ...
  var ReactVideo = function ReactVideo(props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("section", {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(md.MdFullscreen, null)), /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      className: "icon",
      onClick: addp
    }, /*#__PURE__*/React__default['default'].createElement(md.MdAdd, null)))), /*#__PURE__*/React__default['default'].createElement(md.MdMoreHoriz, {
      onContextMenu: function onContextMenu(e) {
        e.preventDefault();
      },
      onClick: mm
    ...
    }, /*#__PURE__*/React__default['default'].createElement(md.MdClose, null)))));
  };
