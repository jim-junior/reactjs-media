(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/slicedToArray'), require('react'), require('react-icons/md'), require('prop-types'), require('@material-ui/core/Tooltip'), require('@material-ui/core/CircularProgress'), require('@material-ui/core/Grid'), require('@material-ui/core/Slider'), require('@material-ui/core/IconButton'), require('@material-ui/core/Typography'), require('@material-ui/core/styles')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/slicedToArray', 'react', 'react-icons/md', 'prop-types', '@material-ui/core/Tooltip', '@material-ui/core/CircularProgress', '@material-ui/core/Grid', '@material-ui/core/Slider', '@material-ui/core/IconButton', '@material-ui/core/Typography', '@material-ui/core/styles'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.reactjsvideo = {}, global._regeneratorRuntime, global._asyncToGenerator, global._slicedToArray, global.React, global.md, global.PropTypes, global.Tooltip, global.CircularProgress, global.Grid, global.Slider, null, global.Typography, global.styles));
}(this, (function (exports, _regeneratorRuntime, _asyncToGenerator, _slicedToArray, React, md, PropTypes, Tooltip, CircularProgress, Grid, Slider, IconButton, Typography, styles) { 'use strict';
  ...
  var ReactVideo = function ReactVideo(props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("style", {
      ...
      variant: "caption",
      component: "span"
    }, ct, " \\ ", video.current ? calcTime(video.current.duration) : /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "00:00"))), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "video-react-pro"
