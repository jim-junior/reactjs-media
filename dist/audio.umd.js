(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/slicedToArray'), require('react'), require('prop-types'), require('react-icons/md'), require('@material-ui/core/Grid'), require('@material-ui/core/Slider'), require('@material-ui/core/IconButton'), require('@material-ui/core/Typography'), require('@material-ui/core/Tooltip'), require('@material-ui/core/Menu'), require('@material-ui/core/MenuItem')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/slicedToArray', 'react', 'prop-types', 'react-icons/md', '@material-ui/core/Grid', '@material-ui/core/Slider', '@material-ui/core/IconButton', '@material-ui/core/Typography', '@material-ui/core/Tooltip', '@material-ui/core/Menu', '@material-ui/core/MenuItem'], factory) :
  (global = global || self, factory(global.ReactAudio = {}, global._regeneratorRuntime, global._asyncToGenerator, global._slicedToArray, global.React, global.PropTypes, global.md, global.Grid, global.Slider, global.IconButton, global.Typography, global.Tooltip, global.Menu, global.MenuItem));
}(this, (function (exports, _regeneratorRuntime, _asyncToGenerator, _slicedToArray, React, PropTypes, md, Grid, Slider, IconButton, Typography, Tooltip, Menu, MenuItem) { 'use strict';
  ...
  Menu = Menu && Object.prototype.hasOwnProperty.call(Menu, 'default') ? Menu['default'] : Menu;
  MenuItem = MenuItem && Object.prototype.hasOwnProperty.call(MenuItem, 'default') ? MenuItem['default'] : MenuItem;
